...
def analisador_sentimentos(nome_do_produto):
    prompt_sistema = f"""
    ...
    print(f"Iniciou a análise de sentimentos do produto {nome_do_produto}")
    ...
    try:
        ...
        salva(f"./dados/analise-{nome_do_produto}.txt", texto_resposta)
